    ...
    public func queryParsing(
        ...
        dispatchQueue.async(group: dispatchGroup) {
            self.instrumentation.queryParsing(
                processId: processId, threadId: threadId, started: started, finished: finished,
    ...
    public func queryValidation(
        ...
        dispatchQueue.async(group: dispatchGroup) {
            self.instrumentation.queryValidation(
                processId: processId, threadId: threadId, started: started, finished: finished,
                schema: schema, document: document, errors: errors)
        }
    }
    ...
    public func operationExecution(
        ...
        dispatchQueue.async(group: dispatchGroup) {
            self.instrumentation.operationExecution(
                processId: processId, threadId: threadId, started: started, finished: finished,
                schema: schema, document: document, rootValue: rootValue,
                eventLoopGroup: eventLoopGroup, variableValues: variableValues,
                operation: operation, errors: errors, result: result)
        }
    }
    ...
    public func fieldResolution(
        ...
        dispatchQueue.async(group: dispatchGroup) {
            self.instrumentation.fieldResolution(
                processId: processId, threadId: threadId, started: started, finished: finished,
                source: source, args: args, eventLoopGroup: eventLoopGroup, info: info,
                result: result)
        }
    }
