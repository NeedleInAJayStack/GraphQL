    ...
    @Test func federationSampleSchema() throws {
        ...
        let productObjectTypeDefinition = ObjectTypeDefinition(
            ...
            fields: [
                ...
                FieldDefinition(
                    name: nameNode("createdBy"), type: typeNode("User"),
                    directives: [
                        Directive(
                ...
                FieldDefinition(
                    name: nameNode("notes"), type: typeNode("String"),
                    directives: [
                        Directive(
                            name: nameNode("tag"),
                            arguments: [
        ...
        let productDimensionObjectTypeDefinition = ObjectTypeDefinition(
            ...
            fields: [
                ...
                FieldDefinition(
                    name: nameNode("unit"), type: typeNode("String"),
                    directives: [
                                ...
                                Directive(
                                    ...
                                    arguments: [
                                        Argument(
                                            ...
                                            value: StringValue(
                                                value: "Use product query instead", block: false)
                                        )
                                    ])
                            ]),
                    ]
            ...
            TypeExtensionDefinition(
                definition: ObjectTypeDefinition(
                    ...
                    fields: [
                        ...
                        FieldDefinition(
                            name: nameNode("name"), type: typeNode("String"),
                            directives: [
                                Directive(
