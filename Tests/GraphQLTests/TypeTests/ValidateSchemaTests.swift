...
let SomeSchema = try! buildSchema(
    source: """
        scalar SomeScalar
...
@Suite struct ValidateSchemaTests {
    ...
    @Test
    func acceptsAnInterfaceWhichImplementsAnInterfaceFieldAlongWithAdditionalOptionalArguments()
        throws
    {
        let schema = try buildSchema(
            source: """
    ...
    @Test
    func rejectsAnInterfaceWhichImplementsAnInterfaceFieldAlongWithAdditionalRequiredArguments()
        throws
    {
        let schema = try buildSchema(
            source: """
